...
namespace UWPSystemBackdropNetNative.PInvoke.Dwmapi
{
    /// <summary>
    /// Dwmapi.dll 函数库
    /// </summary>
    public static partial class DwmapiLibrary
    {
        ...
        [DllImport(Dwmapi, CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint = "DwmSetWindowAttribute", SetLastError = false)]
